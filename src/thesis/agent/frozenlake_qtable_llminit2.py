...
Uso:
    python3 -m thesis.agent.frozenlake_qtable_llminit2 --input <frozenlake_llm>.json --seed 1337 \\
        --episodes 10000 --alpha 0.5 --gamma 0.9 --compare
    python3 -m thesis.agent.frozenlake_qtable_llminit2 --input ... --seed 1337
...
from frozenlake_qtable_llminit import (  # noqa: E402
    DATA_DIR, resolve_input, load_qinit, QLearningAgent, train, evaluate,
